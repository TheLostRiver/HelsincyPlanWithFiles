...
当前版本：`0.1.2`。变更记录见 [CHANGELOG.md](CHANGELOG.md)。
...
推荐普通用户从 Release 下载 `HelsincyPlanWithFiles-v0.1.2-codex.zip`。这个包只包含安装到项目所需的 `.codex/`、hooks、`/pwf-*` commands 和基础文档。

### 方式 A：从 Release 下载

1. 打开 [Latest Release](https://github.com/TheLostRiver/HelsincyPlanWithFiles/releases/latest)。
2. 下载 `HelsincyPlanWithFiles-v0.1.2-codex.zip`。
