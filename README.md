...
- [v0.3.0 Release Notes](docs/RELEASE_NOTES_0.3.0.md)：本次发布的中英双语说明，可直接用于 GitHub Release。
...
推荐普通用户从 Release 下载 `HelsincyPlanWithFiles-v0.3.0-codex.zip`。这个包只包含安装到项目所需的 `.codex/`、hooks、`/pwf-*` commands 和基础文档。

### 方式 A：从 Release 下载

1. 打开 [Latest Release](https://github.com/TheLostRiver/HelsincyPlanWithFiles/releases/latest)。
2. 下载 `HelsincyPlanWithFiles-v0.3.0-codex.zip`。
