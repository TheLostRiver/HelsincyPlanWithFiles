...
当前版本：`0.2.7`。变更记录见 [CHANGELOG.md](CHANGELOG.md)。
...
- [v0.2.7 Release Notes](docs/RELEASE_NOTES_0.2.7.md)：本次发布的中英双语说明，可直接用于 GitHub Release。
...
推荐普通用户从 Release 下载 `HelsincyPlanWithFiles-v0.2.7-codex.zip`。这个包只包含安装到项目所需的 `.codex/`、hooks、`/pwf-*` commands 和基础文档。
