...
| `commands/plw-*.md` | 补充中文 agent 指令，保持 slash command 名称不变 |
...
**Files:**
- Modify: `commands/plw-doctor.md`
- Modify: `commands/plw-init.md`
- Modify: `commands/plw-status.md`
- Modify: `commands/plw-switch.md`
- Modify: `commands/plw-attest.md`
- Modify: `commands/plw-capture.md`
...
```powershell
git add commands tests/test_plw_commands.py
...
- `commands/plw-*.md` 同时支持中文用户和英文用户理解。
- README 中英文都说明中文模式。
